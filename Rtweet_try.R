...
#Using this newer package that gets updated more frequently 
...
mfds <- get_friends(c("hadleywickham", "NateSilver538", "Nate_Cohn"))

#Code snippets provided by Caitlin Gilbert from NEWS NErdery (THANKS)
followers <- get_followers("userhandle", n=1000, page = "-1")
